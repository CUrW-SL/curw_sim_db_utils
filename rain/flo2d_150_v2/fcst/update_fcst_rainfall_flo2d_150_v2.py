...
if __name__=="__main__":
    try:
        ...
        print("{} : ####### Insert fcst rainfall for FLO2D 150 V2 grids".format(datetime.now()))
        flo2d_common.update_rainfall_fcsts(flo2d_model=FLO2D_150_V2, method=method, grid_interpolation=grid_interpolation,
                model_list=model_list, timestep=15)

    except Exception as e:
        traceback.print_exc()
    finally:
        print("{} : ####### fcst rainfall insertion process finished for {} #######".format(datetime.now(), FLO2D_150_V2))
