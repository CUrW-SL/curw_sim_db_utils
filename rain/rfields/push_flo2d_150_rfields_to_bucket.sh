...
echo "Running push_flo2d_150_rfields_to_bucket.py"
python rain/rfields/push_flo2d_150_rfields_to_bucket.py >> rain/rfields/curw_sim_push_flo2d_150_rfields_to_bucket.log 2>&1
