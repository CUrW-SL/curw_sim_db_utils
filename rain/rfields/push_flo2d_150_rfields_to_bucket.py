...
FLO2D_150_RFIELD_BUCKET_DIR = "/mnt/disks/wrf_nfs/flo2d_raincells/150/rfield"
FORWARD = 1
BACKWARD = 5
...
if __name__=="__main__":
    try:
        ...
        for i in range(delta.days + 1):
            ...
            rfield_locations += " {}/{}/*".format(FLO2D_150_RFIELD_DIR, day.strftime("%Y-%m-%d"))
        ...
        print("{} : ####### Push {} rfields to google bucket #######".format(datetime.now(), FLO2D_150))
