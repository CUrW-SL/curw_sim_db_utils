...
ROOT_DIR = '/home/uwcc-admin/curw_sim_db_utils'
...
def usage():
    ...
    Usage: ./grids/obs_stations/update_active_curw_rainfall_stations_for_given_time_range.py [-s "YYYY-MM-DD HH:MM:SS"] [-e "YYYY-MM-DD HH:MM:SS"]
