...
if __name__ == "__main__":
    ...
    try:
        ...
        start_date = datetime.strptime((datetime.now()- timedelta(days=10)).strptime('%Y-%m-%d %H:00:00'),COMMON_DATE_TIME_FORMAT)
        ...
        if tms_id is None:
            ...
            start_date = datetime.strptime((datetime.now() - timedelta(hours=20)).strptime('%Y-%m-%d %H:00:00'),
